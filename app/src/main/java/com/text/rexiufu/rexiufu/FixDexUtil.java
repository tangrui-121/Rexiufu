...
//                file.getName().startsWith("classes") &&
    ...
    private static void doDexInject(Context appContext, HashSet<File> loadedDex) {
        Class classThirdlock = null;
        Object objectThirdlock = null;
        ...
        try {
            ...
            for (File dex : loadedDex) {
                ...
                try {
                    classThirdlock = dexLoader.loadClass("com.text.rexiufu.SDK");
                    objectThirdlock = classThirdlock.newInstance();
                } catch (Exception e) {
                    e.printStackTrace();
                }

                if (classThirdlock != null && objectThirdlock != null) {
                    try {
                        Method method = classThirdlock.getDeclaredMethod("aaa");
                        method.setAccessible(true);
                        method.invoke(objectThirdlock);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
