...
public class TimeView extends View {
    ...
    private void init() {
        ...
        year = Integer.valueOf(TimeUtil.getCurTimeString(new SimpleDateFormat("yyyy")));
        month = Integer.valueOf(TimeUtil.getCurTimeString(new SimpleDateFormat("MM")));
        day = Integer.valueOf(TimeUtil.getCurTimeString(new SimpleDateFormat("dd")));
        hour = Integer.valueOf(TimeUtil.getCurTimeString(new SimpleDateFormat("HH")));
        branch = Integer.valueOf(TimeUtil.getCurTimeString(new SimpleDateFormat("mm")));
        second = Integer.valueOf(TimeUtil.getCurTimeString(new SimpleDateFormat("ss")));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制年
        String my_year = TimeUtil.getUpperDate(TimeUtil.date2String(new Date(), TimeUtil.DEFAULT_SDF1)).substring(0, 5);
        canvas.drawText(my_year, px, py, mPaintSelect);
